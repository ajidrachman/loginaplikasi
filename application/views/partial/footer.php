    ...
    <div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-sm-none d-md-block"><a class="customizer-close"><i class="ft-x font-medium-3"></i></a><a id="customizer-toggle-icon" class="customizer-toggle bg-danger"><i class="ft-settings font-medium-4 fa fa-spin white align-middle"></i></a>
      <div data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a" class="customizer-content p-3 ps-container ps-theme-dark">
        ...
        <div class="cz-bg-image row">
          <div class="col mb-3"><img src="<?php echo base_url(); ?>template/app-assets/img/sidebar-bg/01.jpg" width="50" height="100" alt="Bg image1" class="rounded box-shadow-2"></div>
          <div class="col mb-3"><img src="<?php echo base_url(); ?>template/app-assets/img/sidebar-bg/02.jpg" width="50" height="100" alt="Bg image2" class="rounded box-shadow-2"></div>
          <div class="col mb-3"><img src="<?php echo base_url(); ?>template/app-assets/img/sidebar-bg/03.jpg" width="50" height="100" alt="Bg image3" class="rounded box-shadow-2"></div>
          <div class="col mb-3"><img src="<?php echo base_url(); ?>template/app-assets/img/sidebar-bg/04.jpg" width="50" height="100" alt="Bg image4" class="rounded box-shadow-2"></div>
          <div class="col mb-3"><img src="<?php echo base_url(); ?>template/app-assets/img/sidebar-bg/05.jpg" width="50" height="100" alt="Bg image5" class="rounded box-shadow-2"></div>
          <div class="col mb-3"><img src="<?php echo base_url(); ?>template/app-assets/img/sidebar-bg/06.jpg" width="50" height="100" alt="Bg image6" class="rounded box-shadow-2"></div>
          <div class="col mb-3"><img src="<?php echo base_url(); ?>template/app-assets/img/sidebar-bg/07.jpg" width="50" height="100" alt="Bg image7" class="rounded box-shadow-2"></div>
          <div class="col mb-3"><img src="<?php echo base_url(); ?>template/app-assets/img/sidebar-bg/08.jpg" width="50" height="100" alt="Bg image8" class="rounded box-shadow-2"></div>
        </div>
        <hr>
        <div class="togglebutton">
    ...
    <!-- BEGIN VENDOR JS-->
    <script src="<?php echo base_url(); ?>template/app-assets/vendors/js/core/jquery-3.3.1.min.js"></script>
    <script src="<?php echo base_url(); ?>template/app-assets/vendors/js/core/popper.min.js"></script>
    <script src="<?php echo base_url(); ?>template/app-assets/vendors/js/core/bootstrap.min.js"></script>
    <script src="<?php echo base_url(); ?>template/app-assets/vendors/js/perfect-scrollbar.jquery.min.js"></script>
    <script src="<?php echo base_url(); ?>template/app-assets/vendors/js/prism.min.js"></script>
    <script src="<?php echo base_url(); ?>template/app-assets/vendors/js/jquery.matchHeight-min.js"></script>
    <script src="<?php echo base_url(); ?>template/app-assets/vendors/js/screenfull.min.js"></script>
    <script src="<?php echo base_url(); ?>template/app-assets/vendors/js/pace/pace.min.js"></script>
    <!-- BEGIN VENDOR JS-->
    <!-- BEGIN PAGE VENDOR JS-->
    <script src="<?php echo base_url(); ?>template/app-assets/vendors/js/chartist.min.js"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN CONVEX JS-->
    <script src="<?php echo base_url(); ?>template/app-assets/js/app-sidebar.js"></script>
    <script src="<?php echo base_url(); ?>template/app-assets/js/notification-sidebar.js"></script>
    <script src="<?php echo base_url(); ?>template/app-assets/js/customizer.js"></script>
    <!-- END CONVEX JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="<?php echo base_url(); ?>template/app-assets/js/dashboard-ecommerce.js"></script>
    <script src="<?php echo base_url(); ?>template/app-assets/js/components-modal.min.js"></script>
    <!-- END PAGE LEVEL JS-->
  </body>
</html>